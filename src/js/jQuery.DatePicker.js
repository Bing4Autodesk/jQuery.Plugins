...
; (function ($, window, document, undefined) {
    ...
    $.fn.datepicker = function(o) {
        ...
        if (cp.length == 0) {
            ...
            //end tbody
            cpHA.push("</td></tr>");
            cpHA.push("<tr><td class='bbit-dp-bottom' align='center'><button id='BBIT-DP-OKBTN'>", def.btnOk, "</button><button id='BBIT-DP-TODAY'>", def.btnToday, "</button><button id='BBIT-DP-CLEARBTN'>", def.btnClear, "</button></td></tr>");
